...
function InsightPanel() {
  return (
    <div className="relative hidden overflow-hidden rounded-[32px] border border-white/10 bg-[#111827] lg:block">
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(17,24,39,0.22),rgba(17,24,39,0.9))]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(37,99,235,0.32),transparent_32%)]" />
          ...
          <div className="mx-auto w-full max-w-[30rem]">
            ...
            <form action="/api/auth/login" method="GET" className="space-y-4">
              ...
              <div className="rounded-[22px] border border-primary/12 bg-primary/5 px-4 py-3 text-[0.82rem] text-body">
                Authentication finishes on the secure Auth0 page. We only use this email to take you to the right sign-in flow.
              </div>
            ...
            <div className="mt-8 flex flex-col items-start gap-4 rounded-[24px] border border-border bg-surface px-4 py-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-[0.86rem] font-semibold text-heading">New to Cogent?</p>
                <p className="text-[0.78rem] text-subtle">Create your workspace and start monitoring in minutes.</p>
              </div>
              <Link
                href="/signup"
