...
function RightPanel() {
  return (
    <div className="hidden lg:block relative overflow-hidden">
      <img
        src="/1 (1).png"
        alt="Executive using Cogent intelligence platform in a modern skyscraper"
      ...
      <div className="relative h-full flex flex-col justify-between p-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 px-3 py-1.5">
            ...
            <span className="text-[11px] font-semibold text-white/90 tracking-wide">Live Intelligence</span>
          </div>
        ...
        <div className="space-y-5">
          <blockquote className="space-y-2">
            <p className="text-2xl font-bold text-white leading-snug tracking-tight max-w-[320px]">
              “Strategic clarity<br />in real time.”
            </p>
            <p className="text-sm text-white/70 leading-relaxed max-w-[280px]">
              Cogent delivers AI-powered intelligence briefs for the fastest-moving
              markets — so executives act first.
            </p>
          </blockquote>

          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-full border-2 border-white/20 flex items-center justify-center bg-indigo-500/50 backdrop-blur-sm text-white font-bold text-sm">
              A
            </div>
            <div>
              <p className="text-[13px] font-semibold text-white">Adechukwu Olawale</p>
              <p className="text-[11px] text-white/60">Chief Strategy Officer</p>
            </div>
          </div>
          ...
          <div className="flex gap-6 pt-3 border-t border-white/10">
            {[
              ...
              { label: 'Active domains',  value: '12+'   },
              { label: 'Avg brief time',  value: '< 3s'  },
            ].map(m => (
              <div key={m.label}>
                <p className="text-lg font-bold text-white">{m.value}</p>
                <p className="text-[10px] text-white/50 uppercase tracking-wider leading-tight mt-0.5">{m.label}</p>
              </div>
            ))}
          </div>
        </div>
