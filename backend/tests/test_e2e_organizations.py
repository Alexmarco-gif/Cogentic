...
class TestOrganizationValidation:
    ...
    def test_nonexistent_org_returns_404(self, authed_client, auth_token, requires_auth):
        """
...
class TestMemberManagement:
    ...
    def test_invite_member_requires_admin(self, authed_client, auth_token, requires_auth):
        """
