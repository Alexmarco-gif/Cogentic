...
class TestSQLInjection:
    ...
    def test_sql_injection_in_query_params(self, authed_client, auth_token, requires_auth):
        """
...
class TestPathTraversal:
    ...
    def test_path_traversal_in_document_path(self, authed_client, auth_token, requires_auth):
        """
...
class TestRateLimiting:
    ...
    def test_rate_limit_headers_present(self, client):
        ...
        has_rate_limit = any(
            h.lower() in [k.lower() for k in response.headers.keys()]
...
class TestAuthorizationBypass:
    ...
    def test_cannot_access_other_user_data(self, authed_client, auth_token, requires_auth):
        """
