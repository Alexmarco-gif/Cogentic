...
class TestDocumentList:
    ...
    def test_cannot_list_other_org_documents(
    ...
    def test_list_documents_pagination(self, authed_client, auth_token, requires_auth):
        ...
        response = authed_client.get(
            f"/api/v1/orgs/{org_id}/documents", params={"limit": 5, "offset": 0}
        )
...
class TestDocumentCRUD:
    ...
    def test_create_document(
        self, authed_client, auth_token, requires_auth, test_document_data
    ):
        """
        ...
        response = authed_client.post(
            f"/api/v1/orgs/{org_id}/documents", json=test_document_data
        )
    ...
    def test_cannot_access_other_org_document(
        self, authed_client, auth_token, requires_auth
    ):
        """
...
class TestDocumentValidation:
    ...
    def test_create_document_missing_required_fields(
        self, authed_client, auth_token, requires_auth
    ):
        """
        ...
        response = authed_client.post(f"/api/v1/orgs/{org_id}/documents", json={})
...
class TestDocumentFiltering:
    ...
    def test_filter_by_status(self, authed_client, auth_token, requires_auth):
        ...
        response = authed_client.get(
            f"/api/v1/orgs/{org_id}/documents", params={"status": "completed"}
        )
    ...
    def test_search_documents(self, authed_client, auth_token, requires_auth):
        ...
        response = authed_client.get(
            f"/api/v1/orgs/{org_id}/documents", params={"search": "test"}
        )
