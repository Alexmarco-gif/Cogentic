...
class TestAPIKeyList:
    ...
    def test_cannot_list_other_org_api_keys(self, authed_client, auth_token, requires_auth):
        """
...
class TestAPIKeyCRUD:
    ...
    def test_create_api_key(self, authed_client, auth_token, requires_auth, test_api_key_data):
        """
    ...
    def test_api_key_not_retrievable_after_creation(self, authed_client, auth_token, requires_auth):
        """
    ...
    def test_cannot_delete_other_org_api_key(self, authed_client, auth_token, requires_auth):
        """
...
class TestAPIKeyValidation:
    ...
    def test_create_key_invalid_scopes(self, authed_client, auth_token, requires_auth):
        ...
        response = authed_client.post(
            ...
            json={
                "name": "Test Key",
                "scopes": ["invalid:scope:that:does:not:exist"]
            }
        )
...
class TestAPIKeyRoles:
    ...
    def test_viewer_cannot_create_api_keys(self, authed_client, auth_token, requires_auth):
        """
