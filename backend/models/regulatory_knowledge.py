...
class RegulatoryEvent(Base):
    ...
    affected_sectors: Mapped[list[str] | None] = mapped_column(ARRAY(String), nullable=True)
    affected_entity_types: Mapped[list[str] | None] = mapped_column(ARRAY(String), nullable=True)
    ...
    verified_by_expert: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, index=True)
