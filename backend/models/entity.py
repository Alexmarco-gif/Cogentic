...
class Entity(Base, UUIDMixin, TimestampMixin):
    ...
    # Dynamic Discovery fields (Phase: Intelligence Upgrade)
    # discovery_status: active (auto/manual confirmed), pending_review (auto-created, needs review), rejected
    ...
    # discovery_source: how this entity was created
