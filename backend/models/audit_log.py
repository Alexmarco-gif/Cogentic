...
class AuditLog(Base, UUIDMixin, TimestampMixin):
    ...
    resource_type: Mapped[str | None] = mapped_column(String(100))  # document, user, organization
    ...
    request_id: Mapped[str | None] = mapped_column(String(255))  # Trace requests across services
