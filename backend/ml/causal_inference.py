...
class CausalInferenceService:
    ...
    async def estimate_counterfactual(
        ...
        *,
        ...
        pct_impact = ((avg_actual - avg_synthetic) / avg_synthetic * 100) if avg_synthetic != 0 else 0
    ...
    async def difference_in_differences(
        ...
        *,
        ...
        treatment_pre = await get_avg_metric(treatment_group_metric, pre_start, event_date)
        treatment_post = await get_avg_metric(treatment_group_metric, event_date, post_end)
