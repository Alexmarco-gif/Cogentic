...
async def get_entity_influence_score(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Influence score calculation failed"
        )
...
async def get_key_influencers(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to identify key influencers"
        )
...
async def find_influence_path(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to find influence path")
...
async def predict_influence_cascade(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Influence cascade prediction failed"
        )
