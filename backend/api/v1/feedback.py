...
class FeedbackRequest(BaseModel):
    feedback_type: str = Field(
        ...,
        pattern=r"^(signal_useful|signal_not_useful|signal_saved|signal_shared|signal_dismissed|brief_helpful|brief_not_helpful|entity_relevant|entity_not_relevant|prediction_accurate|prediction_inaccurate)$",
        description=(
    ...
    target_type: str = Field(
        ...,
        pattern=r"^(signal|brief|entity|prediction)$",
        description="One of: signal, brief, entity, prediction",
    )
    target_id: UUID = Field(..., description="UUID of the target object")
