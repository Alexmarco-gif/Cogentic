...
This is the "unreplicable Nigerian business context" moat.
"""
...
class RegulatoryIntelligenceService:
    ...
    REGULATORY_BODIES = {
        ...
        "SEC": ["Securities and Exchange Commission", "SEC Nigeria", "SEC"],
        "FIRS": ["Federal Inland Revenue Service", "FIRS", "tax authority"],
        "NCC": ["Nigerian Communications Commission", "NCC", "telecom regulator"],
        "NERC": ["Nigerian Electricity Regulatory Commission", "NERC"],
        "NAFDAC": ["National Agency for Food and Drug Administration", "NAFDAC"],
        "SON": ["Standards Organisation of Nigeria", "SON"],
        "CAC": ["Corporate Affairs Commission", "CAC"],
        "NAICOM": ["National Insurance Commission", "NAICOM"],
    ...
    def _extract_affected_sectors(self, text: str) -> list[str]:
        ...
        sector_keywords = {
            ...
            "fintech": ["fintech", "payment", "mobile money", "digital finance"],
            "agriculture": ["agriculture", "farming", "agribusiness", "crop"],
            "telecommunications": ["telecom", "telco", "communication service"],
            "energy": ["energy", "power", "electricity", "NERC"],
            "manufacturing": ["manufact", "production", "industrial"],
    ...
    def _extract_affected_entity_types(self, text: str) -> list[str]:
        ...
        entity_types = []
        entity_keywords = {
            "banks": ["bank", "banking institution"],
            "mmos": ["mobile money", "MMO", "payment service"],
            "telcos": ["telecommunications", "telecom", "mobile network"],
            "insurance_companies": ["insurance company", "insurer", "underwriter"],
    ...
    async def _find_related_regulatory_events(
        ...
        """Find semantically similar regulatory events."""
