...
| **Data Stores** | Amazon RDS PostgreSQL + pgvector, Amazon ElastiCache Redis/Valkey, Neo4j | Relational data, caching/queues, knowledge graph |
...
API v1 Router (146+ endpoints)
    ...
    │
    ├── Repository Layer → SQLAlchemy AsyncSession → Amazon RDS PostgreSQL
    │
...
- ✅ **Database Layer** — Amazon RDS PostgreSQL, pgvector, Alembic migrations, async SQLAlchemy
...
- ✅ **CI/CD** — GitHub Actions (lint, typecheck, test, deploy to ECS Fargate)
...
- 📋 AWS infrastructure provisioned (ECR, ECS Fargate, Secrets Manager, RDS, ElastiCache, S3)
