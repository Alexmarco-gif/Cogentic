...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "entity_verified_count", sa.Integer, nullable=False, server_default="0"
        ),
        sa.Column(
            "entity_relationship_count", sa.Integer, nullable=False, server_default="0"
        ),
        sa.Column(
            "entity_source_profile_count",
            sa.Integer,
            nullable=False,
            server_default="0",
        ),
        ...
        sa.Column(
            "prediction_accurate", sa.Integer, nullable=False, server_default="0"
        ),
        sa.Column(
            "prediction_inaccurate", sa.Integer, nullable=False, server_default="0"
        ),
        sa.Column("prediction_accuracy_pct", sa.Float, nullable=True),
        # Metric 4: Replicability Score
        sa.Column(
            "replicability_tests_run", sa.Integer, nullable=False, server_default="0"
        ),
