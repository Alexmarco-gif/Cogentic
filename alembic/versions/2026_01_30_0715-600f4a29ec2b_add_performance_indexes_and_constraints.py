...
Revision ID: 600f4a29ec2b
Revises: a762f3897625
Create Date: 2026-01-30 07:15:00.000000
...
def upgrade() -> None:
    ...
    if (
        "uq_org_user" not in existing_uqs
        and "uq_org_users_org_user" not in existing_uqs
    ):
