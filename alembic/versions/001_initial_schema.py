...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('data_region', sa.String(50), server_default="'us-east'", nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('NOW()'), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('NOW()'), nullable=False),
        sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    )
    op.create_index('idx_orgs_slug', 'organizations', ['slug'])
    op.create_index('idx_orgs_deleted', 'organizations', ['deleted_at'], postgresql_where=sa.text('deleted_at IS NULL'))
    ...
    op.create_table(
        ...
        sa.Column('data_processing_consent', sa.Boolean, server_default='false', nullable=False),
    ...
    op.create_index('idx_users_deleted', 'users', ['deleted_at'], postgresql_where=sa.text('deleted_at IS NULL'))
    ...
    op.create_index('idx_docs_retention', 'documents', ['retention_date'], postgresql_where=sa.text('retention_date IS NOT NULL'))
    op.create_index('idx_docs_deleted', 'documents', ['deleted_at'], postgresql_where=sa.text('deleted_at IS NULL'))
    ...
    op.create_index('idx_jobs_status', 'ai_jobs', ['status', 'priority'], postgresql_where=sa.text("status IN ('queued', 'running')"))
    ...
    op.create_table(
        ...
        sa.Column('usage_current_period', postgresql.JSONB, server_default='{}', nullable=False),
    ...
    op.create_index('idx_audit_org', 'audit_logs', ['org_id', sa.text('created_at DESC')])
